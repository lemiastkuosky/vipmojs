...
// 1. BUSCA DADOS + CARRO ATIVO (Agora com PLACA)
$sql_top = "
    SELECT 
...
$placa_carro = $dado_top['placa'] ?? '---'; // Pega a placa
...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .active-car-widget {
        ...
        padding-right: 15px; min-width: 150px;
    ...
    .car-dash-grid { display: flex; gap: 8px; justify-content: center; }
    .dash-item { display: flex; align-items: center; gap: 4px; }
    .dash-icon { font-size: 9px; width: 12px; text-align: center; }
    .dash-bar-bg { width: 30px; height: 3px; background: #333; border-radius: 1px; }
